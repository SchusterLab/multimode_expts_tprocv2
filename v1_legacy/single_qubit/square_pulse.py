...
"""
class SquarePulseProgram(AveragerProgram):
    ...
    def initialize(self):
        ...
        self.dac_ch = cfg.hw.soc.dacs.flux_storage.ch
        self.dac_ch_type = cfg.hw.soc.dacs.flux_storage.type
    ...
    def body(self):
        ...
        self.setup_and_pulse(ch=self.dac_ch, style="const", freq=self.freqreg, phase=0, gain=self.gain, length=self.pulse_length)
...
class SquarePulseExperiment(Experiment):
    ...
    def __init__(self, soccfg=None, path='', prefix='SquarePulse', config_file=None, progress=None):
    ...
    def acquire(self, progress=False):
        ...
        tof = SquarePulseProgram(soccfg=self.soccfg, cfg=self.cfg)
