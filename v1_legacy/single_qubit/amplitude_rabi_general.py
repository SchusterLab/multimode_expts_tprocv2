...
class AmplitudeRabiGeneralProgram(MMRAveragerProgram):
    ...
    def body(self):
        ...
        if cfg.expt.f0g1_cavity > 0:
            ...
            self.sync_all() # align channels
            self.setup_and_pulse(ch=self.f0g1_ch[0], style="const", freq=self.f0g1, phase=0, gain=self.pif0g1_gain, length=self.f0g1_length)
            self.sync_all() # align channels
...
class AmplitudeRabiGeneralExperiment(Experiment):
    """
