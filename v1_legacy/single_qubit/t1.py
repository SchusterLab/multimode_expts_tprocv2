...
class T1Program(RAveragerProgram):
    ...
    def body(self):
        ...
        if self.cfg.expt.qubit_ef:
            self.set_pulse_registers(ch=self.qubit_ch, style="arb", freq=self.f_ef_reg, phase=0, gain=cfg.device.qubit.pulses.pi_ef.gain, waveform="pief_qubit")
            self.pulse(ch=self.qubit_ch)
...
class T1Experiment(Experiment):
    ...
    def acquire(self, progress=False, debug=False):
        ...
        data['I'], data['Q'] = t1.collect_shots()
