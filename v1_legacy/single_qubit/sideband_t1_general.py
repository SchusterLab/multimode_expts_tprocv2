...
class SidebandT1GeneralProgram(MMAveragerProgram):
    ...
    # def custom_pulse(self, cfg, pulse_data, prefix = 'pre'): 
    #     '''
    ...
    #                 self.add_gauss(ch=self.tempch[0], name="temp_gaussian" + str(jj) + prefix,
    #                    sigma=self.pisigma_resolved, length=self.pisigma_resolved*4)
    ...
    def body(self):
        ...
        if self.cfg.expt.length_placeholder>0:
            ...
            self.sync_all(self.us2cycles(self.cfg.expt.length_placeholder))  # align channels
...
class SidebandT1GeneralExperiment(Experiment):
    """
    ...
    def __init__(self, soccfg=None, path='', prefix='SidebandT1General', config_file=None, progress=None):
    ...
    def acquire(self, progress=False, debug=False):
        ...
        for length in tqdm(lengths, disable=not progress):
            ...
            lengthrabi = SidebandT1GeneralProgram(
