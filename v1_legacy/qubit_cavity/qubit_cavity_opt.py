...
class QubitCavityOptProgram(AveragerProgram):
    def initialize(self):
        ...
        # print(self.qubit_chs[qTest]['maxv'])
        self.add_opt_pulse(ch=self.qubit_chs[qTest], name="test_opt_qubit", pulse_location=cfg.expt.opt_file_path[0])
        self.add_opt_pulse(ch=self.man_chs[qTest], name="test_opt_cavity", pulse_location=cfg.expt.opt_file_path[1])
...
class QubitCavityOptExperiment(Experiment):
    ...
    def __init__(self, soccfg=None, path='', prefix='QubitCavityOpt', config_file=None, progress=None):
    ...
    def acquire(self, progress=False):
        ...
        prog = QubitCavityOptProgram(soccfg=self.soccfg, cfg=self.cfg)
        self.prog = prog
