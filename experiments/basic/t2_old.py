...
#         """
#         print('Final Delay is ', final_delay)
...
#         #super().make_pi_pulse(cfg.expt.qubit[0], cfg.device.qubit.f_ge, "pi_ge") # for debug
...
#         params_def = {
#             "reps": 2 * 100,#self.reps,  # Number of repetitions (inner loop)
#             "rounds": 1,#self.rounds,  # Number of averages (outer loop)
...
#             cfg_qub = self.cfg.device.qubit.pulses.hpi_ef
#             params_def["freq"] = self.cfg.device.qubit.f_ef[qi]
#         else:
#             # For g-e transition measurements (standard)
#             cfg_qub = self.cfg.device.qubit.pulses.hpi_ge
